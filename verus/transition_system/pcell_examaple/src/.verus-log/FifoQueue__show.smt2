...
(assert
 (distinct fuel%vstd!cell.impl&%2.is_init. fuel%vstd!cell.impl&%2.is_uninit. fuel%vstd!map.impl&%0.spec_index.
  ...
  fuel%vstd!set.axiom_set_remove_finite. fuel%main!FifoQueue.impl&%19.initialize. fuel%main!FifoQueue.impl&%19.produce_start.
  fuel%main!FifoQueue.impl&%19.produce_end. fuel%main!FifoQueue.impl&%19.consume_start.
  fuel%main!FifoQueue.impl&%19.consume_end. fuel%main!FifoQueue.impl&%19.inc_wrap.
...
(declare-datatypes ((vstd!raw_ptr.MemContents. 0) (main!FifoQueue.State. 0) (main!ProducerState.
   0
  ) (main!ConsumerState. 0) (tuple%0. 0)
...
;; Function-Specs main::FifoQueue::show::produce_start
(declare-fun req%main!FifoQueue.show.produce_start. (Dcr Type main!FifoQueue.State.
...
(assert
 (forall ((T&. Dcr) (T& Type) (pre! main!FifoQueue.State.) (post! main!FifoQueue.State.))
  (!
   (= (req%main!FifoQueue.show.produce_start. T&. T& pre! post!) (=>
     %%global_location_label%%4
     (main!FifoQueue.impl&%19.produce_start.? T&. T& (Poly%main!FifoQueue.State. pre!)
      (Poly%main!FifoQueue.State. post!)
   )))
   :pattern ((req%main!FifoQueue.show.produce_start. T&. T& pre! post!))
   :qid internal_req__main!FifoQueue.show.produce_start._definition
   :skolemid skolem_internal_req__main!FifoQueue.show.produce_start._definition
)))
(declare-fun ens%main!FifoQueue.show.produce_start. (Dcr Type main!FifoQueue.State.
  main!FifoQueue.State.
 ) Bool
)
(assert
 (forall ((T&. Dcr) (T& Type) (pre! main!FifoQueue.State.) (post! main!FifoQueue.State.))
  (!
   (= (ens%main!FifoQueue.show.produce_start. T&. T& pre! post!) (main!FifoQueue.impl&%19.next.?
     T&. T& (Poly%main!FifoQueue.State. pre!) (Poly%main!FifoQueue.State. post!)
   ))
   :pattern ((ens%main!FifoQueue.show.produce_start. T&. T& pre! post!))
   :qid internal_ens__main!FifoQueue.show.produce_start._definition
   :skolemid skolem_internal_ens__main!FifoQueue.show.produce_start._definition
)))

;; Function-Specs main::FifoQueue::show::produce_end
(declare-fun req%main!FifoQueue.show.produce_end. (Dcr Type main!FifoQueue.State. main!FifoQueue.State.
  Poly
 ) Bool
)
...
(assert
 (forall ((T&. Dcr) (T& Type) (pre! main!FifoQueue.State.) (post! main!FifoQueue.State.)
   ...
   (= (req%main!FifoQueue.show.produce_end. T&. T& pre! post! perm!) (=>
     %%global_location_label%%5
     (main!FifoQueue.impl&%19.produce_end.? T&. T& (Poly%main!FifoQueue.State. pre!) (Poly%main!FifoQueue.State.
       post!
      ) perm!
   )))
   :pattern ((req%main!FifoQueue.show.produce_end. T&. T& pre! post! perm!))
   :qid internal_req__main!FifoQueue.show.produce_end._definition
   :skolemid skolem_internal_req__main!FifoQueue.show.produce_end._definition
)))
(declare-fun ens%main!FifoQueue.show.produce_end. (Dcr Type main!FifoQueue.State. main!FifoQueue.State.
  Poly
 ) Bool
)
(assert
 (forall ((T&. Dcr) (T& Type) (pre! main!FifoQueue.State.) (post! main!FifoQueue.State.)
   ...
   (= (ens%main!FifoQueue.show.produce_end. T&. T& pre! post! perm!) (main!FifoQueue.impl&%19.next.?
     T&. T& (Poly%main!FifoQueue.State. pre!) (Poly%main!FifoQueue.State. post!)
   ))
   :pattern ((ens%main!FifoQueue.show.produce_end. T&. T& pre! post! perm!))
   :qid internal_ens__main!FifoQueue.show.produce_end._definition
   :skolemid skolem_internal_ens__main!FifoQueue.show.produce_end._definition
)))

;; Function-Specs main::FifoQueue::show::consume_start
(declare-fun req%main!FifoQueue.show.consume_start. (Dcr Type main!FifoQueue.State.
  main!FifoQueue.State.
 ) Bool
)
...
(assert
 (forall ((T&. Dcr) (T& Type) (pre! main!FifoQueue.State.) (post! main!FifoQueue.State.))
  (!
   (= (req%main!FifoQueue.show.consume_start. T&. T& pre! post!) (=>
     %%global_location_label%%6
     (main!FifoQueue.impl&%19.consume_start.? T&. T& (Poly%main!FifoQueue.State. pre!)
      (Poly%main!FifoQueue.State. post!)
   )))
   :pattern ((req%main!FifoQueue.show.consume_start. T&. T& pre! post!))
   :qid internal_req__main!FifoQueue.show.consume_start._definition
   :skolemid skolem_internal_req__main!FifoQueue.show.consume_start._definition
)))
(declare-fun ens%main!FifoQueue.show.consume_start. (Dcr Type main!FifoQueue.State.
  main!FifoQueue.State.
 ) Bool
)
(assert
 (forall ((T&. Dcr) (T& Type) (pre! main!FifoQueue.State.) (post! main!FifoQueue.State.))
  (!
   (= (ens%main!FifoQueue.show.consume_start. T&. T& pre! post!) (main!FifoQueue.impl&%19.next.?
     T&. T& (Poly%main!FifoQueue.State. pre!) (Poly%main!FifoQueue.State. post!)
   ))
   :pattern ((ens%main!FifoQueue.show.consume_start. T&. T& pre! post!))
   :qid internal_ens__main!FifoQueue.show.consume_start._definition
   :skolemid skolem_internal_ens__main!FifoQueue.show.consume_start._definition
)))

;; Function-Specs main::FifoQueue::show::consume_end
(declare-fun req%main!FifoQueue.show.consume_end. (Dcr Type main!FifoQueue.State. main!FifoQueue.State.
  Poly
 ) Bool
)
...
(assert
 (forall ((T&. Dcr) (T& Type) (pre! main!FifoQueue.State.) (post! main!FifoQueue.State.)
   ...
   (= (req%main!FifoQueue.show.consume_end. T&. T& pre! post! perm!) (=>
     %%global_location_label%%7
     (main!FifoQueue.impl&%19.consume_end.? T&. T& (Poly%main!FifoQueue.State. pre!) (Poly%main!FifoQueue.State.
       post!
      ) perm!
   )))
   :pattern ((req%main!FifoQueue.show.consume_end. T&. T& pre! post! perm!))
   :qid internal_req__main!FifoQueue.show.consume_end._definition
   :skolemid skolem_internal_req__main!FifoQueue.show.consume_end._definition
)))
(declare-fun ens%main!FifoQueue.show.consume_end. (Dcr Type main!FifoQueue.State. main!FifoQueue.State.
  Poly
 ) Bool
)
(assert
 (forall ((T&. Dcr) (T& Type) (pre! main!FifoQueue.State.) (post! main!FifoQueue.State.)
   ...
   (= (ens%main!FifoQueue.show.consume_end. T&. T& pre! post! perm!) (main!FifoQueue.impl&%19.next.?
     T&. T& (Poly%main!FifoQueue.State. pre!) (Poly%main!FifoQueue.State. post!)
   ))
   :pattern ((ens%main!FifoQueue.show.consume_end. T&. T& pre! post! perm!))
   :qid internal_ens__main!FifoQueue.show.consume_end._definition
   :skolemid skolem_internal_ens__main!FifoQueue.show.consume_end._definition
)))
...
;; Function-Specs main::FifoQueue::show::initialize
(declare-fun req%main!FifoQueue.show.initialize. (Dcr Type main!FifoQueue.State. vstd!seq.Seq<vstd!cell.CellId.>.
  Poly
 ) Bool
)
...
(assert
 (forall ((T&. Dcr) (T& Type) (post! main!FifoQueue.State.) (backing_cells! vstd!seq.Seq<vstd!cell.CellId.>.)
   ...
   (= (req%main!FifoQueue.show.initialize. T&. T& post! backing_cells! storage!) (=>
     %%global_location_label%%8
     (main!FifoQueue.impl&%19.initialize.? T&. T& (Poly%main!FifoQueue.State. post!) (Poly%vstd!seq.Seq<vstd!cell.CellId.>.
       backing_cells!
      ) storage!
   )))
   :pattern ((req%main!FifoQueue.show.initialize. T&. T& post! backing_cells! storage!))
   :qid internal_req__main!FifoQueue.show.initialize._definition
   :skolemid skolem_internal_req__main!FifoQueue.show.initialize._definition
)))
(declare-fun ens%main!FifoQueue.show.initialize. (Dcr Type main!FifoQueue.State. vstd!seq.Seq<vstd!cell.CellId.>.
  Poly
 ) Bool
)
(assert
 (forall ((T&. Dcr) (T& Type) (post! main!FifoQueue.State.) (backing_cells! vstd!seq.Seq<vstd!cell.CellId.>.)
   ...
   (= (ens%main!FifoQueue.show.initialize. T&. T& post! backing_cells! storage!) (main!FifoQueue.impl&%19.init.?
     T&. T& (Poly%main!FifoQueue.State. post!)
   ))
   :pattern ((ens%main!FifoQueue.show.initialize. T&. T& post! backing_cells! storage!))
   :qid internal_ens__main!FifoQueue.show.initialize._definition
   :skolemid skolem_internal_ens__main!FifoQueue.show.initialize._definition
)))
