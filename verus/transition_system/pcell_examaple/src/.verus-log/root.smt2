...
(declare-const fuel%withdraw_deposit!impl&%0.atomic_inv. FuelId)
(declare-const fuel%withdraw_deposit!impl&%1.wf. FuelId)
...
(assert
 (distinct fuel%vstd!std_specs.option.impl&%0.view. fuel%vstd!std_specs.vec.axiom_spec_len.
  ...
  fuel%vstd!cell.option_from_mem_contents. fuel%vstd!cell.impl&%2.view. fuel%vstd!cell.impl&%2.is_uninit.
  fuel%vstd!invariant.AtomicInvariant.inv. fuel%vstd!map.impl&%0.spec_index. fuel%vstd!map.axiom_map_index_decreases_finite.
  ...
  fuel%vstd!map.axiom_map_ext_equal. fuel%vstd!map.axiom_map_ext_equal_deep. fuel%vstd!raw_ptr.impl&%3.view.
  fuel%vstd!raw_ptr.impl&%6.is_uninit. fuel%vstd!raw_ptr.ptrs_mut_eq. fuel%vstd!raw_ptr.ptrs_mut_eq_sized.
  ...
  fuel%vstd!seq.axiom_seq_ext_equal. fuel%vstd!seq.axiom_seq_ext_equal_deep. fuel%vstd!set.Set.full.
  fuel%vstd!set.Set.subset_of. fuel%vstd!set.axiom_set_empty. fuel%vstd!set.axiom_set_insert_same.
  fuel%vstd!set.axiom_set_insert_different. fuel%vstd!set.axiom_set_remove_same. fuel%vstd!set.axiom_set_remove_insert.
  fuel%vstd!set.axiom_set_remove_different. fuel%vstd!set.axiom_set_complement. fuel%vstd!set.axiom_set_ext_equal.
  fuel%vstd!set.axiom_set_ext_equal_deep. fuel%vstd!set.axiom_set_empty_finite. fuel%vstd!set.axiom_set_insert_finite.
  fuel%vstd!set.axiom_set_remove_finite. fuel%vstd!set_lib.lemma_set_subset_finite.
  ...
  fuel%vstd!view.impl&%18.view. fuel%vstd!view.impl&%20.view. fuel%vstd!view.impl&%24.view.
  fuel%vstd!view.impl&%42.view. fuel%withdraw_deposit!impl&%0.atomic_inv. fuel%withdraw_deposit!impl&%1.wf.
...
(declare-sort vstd!atomic_ghost.AtomicPredU64<withdraw_deposit!InvariantPredicate_auto_VBBuffer_start.>.
 0
)
...
(declare-datatypes ((core!option.Option. 0) (vstd!atomic.PermissionDataU64. 0) (vstd!atomic_ghost.AtomicU64.
   ...
   0
  ) (vstd!tokens.InstanceId. 0) (withdraw_deposit!VBBuffer. 0) (withdraw_deposit!InvariantPredicate_auto_VBBuffer_start.
   0
  ) (tuple%0. 0) (tuple%2. 0)
  ...
  ((withdraw_deposit!VBBuffer./VBBuffer (withdraw_deposit!VBBuffer./VBBuffer/?buffer Poly)
    (withdraw_deposit!VBBuffer./VBBuffer/?start vstd!atomic_ghost.AtomicU64.) (withdraw_deposit!VBBuffer./VBBuffer/?instance
     Poly
   ))
  ) ((withdraw_deposit!InvariantPredicate_auto_VBBuffer_start./InvariantPredicate_auto_VBBuffer_start))
...
(declare-fun withdraw_deposit!VBBuffer./VBBuffer/buffer (withdraw_deposit!VBBuffer.)
 Poly
)
(declare-fun withdraw_deposit!VBBuffer./VBBuffer/start (withdraw_deposit!VBBuffer.)
 vstd!atomic_ghost.AtomicU64.
)
(declare-fun withdraw_deposit!VBBuffer./VBBuffer/instance (withdraw_deposit!VBBuffer.)
 Poly
)
...
(declare-fun TYPE%withdraw_deposit!VBQueue.Instance. (Dcr Type) Type)
(declare-fun TYPE%withdraw_deposit!VBQueue.start. (Dcr Type) Type)
(declare-fun TYPE%withdraw_deposit!VBBuffer. (Dcr Type) Type)
(declare-const TYPE%withdraw_deposit!InvariantPredicate_auto_VBBuffer_start. Type)
...
(declare-fun Poly%vstd!atomic_ghost.AtomicPredU64<withdraw_deposit!InvariantPredicate_auto_VBBuffer_start.>.
 (vstd!atomic_ghost.AtomicPredU64<withdraw_deposit!InvariantPredicate_auto_VBBuffer_start.>.)
 Poly
)
(declare-fun %Poly%vstd!atomic_ghost.AtomicPredU64<withdraw_deposit!InvariantPredicate_auto_VBBuffer_start.>.
 (Poly) vstd!atomic_ghost.AtomicPredU64<withdraw_deposit!InvariantPredicate_auto_VBBuffer_start.>.
)
...
(declare-fun Poly%withdraw_deposit!VBBuffer. (withdraw_deposit!VBBuffer.) Poly)
(declare-fun %Poly%withdraw_deposit!VBBuffer. (Poly) withdraw_deposit!VBBuffer.)
(declare-fun Poly%withdraw_deposit!InvariantPredicate_auto_VBBuffer_start. (withdraw_deposit!InvariantPredicate_auto_VBBuffer_start.)
 Poly
)
(declare-fun %Poly%withdraw_deposit!InvariantPredicate_auto_VBBuffer_start. (Poly)
 withdraw_deposit!InvariantPredicate_auto_VBBuffer_start.
)
...
(assert
 (forall ((x vstd!atomic_ghost.AtomicPredU64<withdraw_deposit!InvariantPredicate_auto_VBBuffer_start.>.))
  (!
   (= x (%Poly%vstd!atomic_ghost.AtomicPredU64<withdraw_deposit!InvariantPredicate_auto_VBBuffer_start.>.
     (Poly%vstd!atomic_ghost.AtomicPredU64<withdraw_deposit!InvariantPredicate_auto_VBBuffer_start.>.
      x
   )))
   :pattern ((Poly%vstd!atomic_ghost.AtomicPredU64<withdraw_deposit!InvariantPredicate_auto_VBBuffer_start.>.
     x
   ))
   :qid internal_vstd__atomic_ghost__AtomicPredU64<withdraw_deposit!InvariantPredicate_auto_VBBuffer_start.>_box_axiom_definition
   :skolemid skolem_internal_vstd__atomic_ghost__AtomicPredU64<withdraw_deposit!InvariantPredicate_auto_VBBuffer_start.>_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x (TYPE%vstd!atomic_ghost.AtomicPredU64. $ TYPE%withdraw_deposit!InvariantPredicate_auto_VBBuffer_start.))
    (= x (Poly%vstd!atomic_ghost.AtomicPredU64<withdraw_deposit!InvariantPredicate_auto_VBBuffer_start.>.
      (%Poly%vstd!atomic_ghost.AtomicPredU64<withdraw_deposit!InvariantPredicate_auto_VBBuffer_start.>.
       x
   ))))
   :pattern ((has_type x (TYPE%vstd!atomic_ghost.AtomicPredU64. $ TYPE%withdraw_deposit!InvariantPredicate_auto_VBBuffer_start.)))
   :qid internal_vstd__atomic_ghost__AtomicPredU64<withdraw_deposit!InvariantPredicate_auto_VBBuffer_start.>_unbox_axiom_definition
   :skolemid skolem_internal_vstd__atomic_ghost__AtomicPredU64<withdraw_deposit!InvariantPredicate_auto_VBBuffer_start.>_unbox_axiom_definition
)))
(assert
 (forall ((x vstd!atomic_ghost.AtomicPredU64<withdraw_deposit!InvariantPredicate_auto_VBBuffer_start.>.))
  (!
   (has_type (Poly%vstd!atomic_ghost.AtomicPredU64<withdraw_deposit!InvariantPredicate_auto_VBBuffer_start.>.
     x
    ) (TYPE%vstd!atomic_ghost.AtomicPredU64. $ TYPE%withdraw_deposit!InvariantPredicate_auto_VBBuffer_start.)
   )
   :pattern ((has_type (Poly%vstd!atomic_ghost.AtomicPredU64<withdraw_deposit!InvariantPredicate_auto_VBBuffer_start.>.
      x
     ) (TYPE%vstd!atomic_ghost.AtomicPredU64. $ TYPE%withdraw_deposit!InvariantPredicate_auto_VBBuffer_start.)
   ))
   :qid internal_vstd__atomic_ghost__AtomicPredU64<withdraw_deposit!InvariantPredicate_auto_VBBuffer_start.>_has_type_always_definition
   :skolemid skolem_internal_vstd__atomic_ghost__AtomicPredU64<withdraw_deposit!InvariantPredicate_auto_VBBuffer_start.>_has_type_always_definition
)))
(assert
...
(assert
 (forall ((x withdraw_deposit!VBBuffer.)) (!
   (= x (%Poly%withdraw_deposit!VBBuffer. (Poly%withdraw_deposit!VBBuffer. x)))
   :pattern ((Poly%withdraw_deposit!VBBuffer. x))
   :qid internal_withdraw_deposit__VBBuffer_box_axiom_definition
   :skolemid skolem_internal_withdraw_deposit__VBBuffer_box_axiom_definition
)))
(assert
 (forall ((T&. Dcr) (T& Type) (x Poly)) (!
   (=>
    (has_type x (TYPE%withdraw_deposit!VBBuffer. T&. T&))
    (= x (Poly%withdraw_deposit!VBBuffer. (%Poly%withdraw_deposit!VBBuffer. x)))
   )
   :pattern ((has_type x (TYPE%withdraw_deposit!VBBuffer. T&. T&)))
   :qid internal_withdraw_deposit__VBBuffer_unbox_axiom_definition
   :skolemid skolem_internal_withdraw_deposit__VBBuffer_unbox_axiom_definition
)))
(assert
 (forall ((T&. Dcr) (T& Type) (_buffer! Poly) (_start! vstd!atomic_ghost.AtomicU64.)
   (_instance! Poly)
  ) (!
   (=>
    (and
     (has_type _buffer! (TYPE%alloc!vec.Vec. $ (TYPE%vstd!cell.PCell. T&. T&) $ ALLOCATOR_GLOBAL))
     (has_type (Poly%vstd!atomic_ghost.AtomicU64. _start!) (TYPE%vstd!atomic_ghost.AtomicU64.
       (TRACKED $) (TYPE%withdraw_deposit!VBQueue.Instance. T&. T&) $ (TYPE%withdraw_deposit!VBQueue.start.
        T&. T&
       ) $ TYPE%withdraw_deposit!InvariantPredicate_auto_VBBuffer_start.
     ))
     (has_type _instance! (TYPE%withdraw_deposit!VBQueue.Instance. T&. T&))
    )
    (has_type (Poly%withdraw_deposit!VBBuffer. (withdraw_deposit!VBBuffer./VBBuffer _buffer!
       _start! _instance!
      )
     ) (TYPE%withdraw_deposit!VBBuffer. T&. T&)
   ))
   :pattern ((has_type (Poly%withdraw_deposit!VBBuffer. (withdraw_deposit!VBBuffer./VBBuffer
       _buffer! _start! _instance!
      )
     ) (TYPE%withdraw_deposit!VBBuffer. T&. T&)
   ))
   :qid internal_withdraw_deposit!VBBuffer./VBBuffer_constructor_definition
   :skolemid skolem_internal_withdraw_deposit!VBBuffer./VBBuffer_constructor_definition
)))
(assert
 (forall ((x withdraw_deposit!VBBuffer.)) (!
   (= (withdraw_deposit!VBBuffer./VBBuffer/buffer x) (withdraw_deposit!VBBuffer./VBBuffer/?buffer
     x
   ))
   :pattern ((withdraw_deposit!VBBuffer./VBBuffer/buffer x))
   :qid internal_withdraw_deposit!VBBuffer./VBBuffer/buffer_accessor_definition
   :skolemid skolem_internal_withdraw_deposit!VBBuffer./VBBuffer/buffer_accessor_definition
)))
(assert
 (forall ((T&. Dcr) (T& Type) (x Poly)) (!
   (=>
    (has_type x (TYPE%withdraw_deposit!VBBuffer. T&. T&))
    (has_type (withdraw_deposit!VBBuffer./VBBuffer/buffer (%Poly%withdraw_deposit!VBBuffer.
       x
      )
     ) (TYPE%alloc!vec.Vec. $ (TYPE%vstd!cell.PCell. T&. T&) $ ALLOCATOR_GLOBAL)
   ))
   :pattern ((withdraw_deposit!VBBuffer./VBBuffer/buffer (%Poly%withdraw_deposit!VBBuffer.
      x
     )
    ) (has_type x (TYPE%withdraw_deposit!VBBuffer. T&. T&))
   )
   :qid internal_withdraw_deposit!VBBuffer./VBBuffer/buffer_invariant_definition
   :skolemid skolem_internal_withdraw_deposit!VBBuffer./VBBuffer/buffer_invariant_definition
)))
(assert
 (forall ((x withdraw_deposit!VBBuffer.)) (!
   (= (withdraw_deposit!VBBuffer./VBBuffer/start x) (withdraw_deposit!VBBuffer./VBBuffer/?start
     x
   ))
   :pattern ((withdraw_deposit!VBBuffer./VBBuffer/start x))
   :qid internal_withdraw_deposit!VBBuffer./VBBuffer/start_accessor_definition
   :skolemid skolem_internal_withdraw_deposit!VBBuffer./VBBuffer/start_accessor_definition
)))
(assert
 (forall ((T&. Dcr) (T& Type) (x Poly)) (!
   (=>
    (has_type x (TYPE%withdraw_deposit!VBBuffer. T&. T&))
    (has_type (Poly%vstd!atomic_ghost.AtomicU64. (withdraw_deposit!VBBuffer./VBBuffer/start
       (%Poly%withdraw_deposit!VBBuffer. x)
      )
     ) (TYPE%vstd!atomic_ghost.AtomicU64. (TRACKED $) (TYPE%withdraw_deposit!VBQueue.Instance.
       T&. T&
      ) $ (TYPE%withdraw_deposit!VBQueue.start. T&. T&) $ TYPE%withdraw_deposit!InvariantPredicate_auto_VBBuffer_start.
   )))
   :pattern ((withdraw_deposit!VBBuffer./VBBuffer/start (%Poly%withdraw_deposit!VBBuffer.
      x
     )
    ) (has_type x (TYPE%withdraw_deposit!VBBuffer. T&. T&))
   )
   :qid internal_withdraw_deposit!VBBuffer./VBBuffer/start_invariant_definition
   :skolemid skolem_internal_withdraw_deposit!VBBuffer./VBBuffer/start_invariant_definition
)))
(assert
 (forall ((x withdraw_deposit!VBBuffer.)) (!
   (= (withdraw_deposit!VBBuffer./VBBuffer/instance x) (withdraw_deposit!VBBuffer./VBBuffer/?instance
     x
   ))
   :pattern ((withdraw_deposit!VBBuffer./VBBuffer/instance x))
   :qid internal_withdraw_deposit!VBBuffer./VBBuffer/instance_accessor_definition
   :skolemid skolem_internal_withdraw_deposit!VBBuffer./VBBuffer/instance_accessor_definition
)))
(assert
 (forall ((T&. Dcr) (T& Type) (x Poly)) (!
   (=>
    (has_type x (TYPE%withdraw_deposit!VBBuffer. T&. T&))
    (has_type (withdraw_deposit!VBBuffer./VBBuffer/instance (%Poly%withdraw_deposit!VBBuffer.
       x
      )
     ) (TYPE%withdraw_deposit!VBQueue.Instance. T&. T&)
   ))
   :pattern ((withdraw_deposit!VBBuffer./VBBuffer/instance (%Poly%withdraw_deposit!VBBuffer.
      x
     )
    ) (has_type x (TYPE%withdraw_deposit!VBBuffer. T&. T&))
   )
   :qid internal_withdraw_deposit!VBBuffer./VBBuffer/instance_invariant_definition
   :skolemid skolem_internal_withdraw_deposit!VBBuffer./VBBuffer/instance_invariant_definition
)))
(assert
 (forall ((x withdraw_deposit!VBBuffer.)) (!
   (=>
    (is-withdraw_deposit!VBBuffer./VBBuffer x)
    (height_lt (height (withdraw_deposit!VBBuffer./VBBuffer/buffer x)) (height (Poly%withdraw_deposit!VBBuffer.
       x
   ))))
   :pattern ((height (withdraw_deposit!VBBuffer./VBBuffer/buffer x)))
   :qid prelude_datatype_height_withdraw_deposit!VBBuffer./VBBuffer/buffer
   :skolemid skolem_prelude_datatype_height_withdraw_deposit!VBBuffer./VBBuffer/buffer
)))
(assert
 (forall ((x withdraw_deposit!VBBuffer.)) (!
   (=>
    (is-withdraw_deposit!VBBuffer./VBBuffer x)
    (height_lt (height (Poly%vstd!atomic_ghost.AtomicU64. (withdraw_deposit!VBBuffer./VBBuffer/start
        x
      ))
     ) (height (Poly%withdraw_deposit!VBBuffer. x))
   ))
   :pattern ((height (Poly%vstd!atomic_ghost.AtomicU64. (withdraw_deposit!VBBuffer./VBBuffer/start
       x
   ))))
   :qid prelude_datatype_height_withdraw_deposit!VBBuffer./VBBuffer/start
   :skolemid skolem_prelude_datatype_height_withdraw_deposit!VBBuffer./VBBuffer/start
)))
(assert
 (forall ((x withdraw_deposit!VBBuffer.)) (!
   (=>
    (is-withdraw_deposit!VBBuffer./VBBuffer x)
    (height_lt (height (withdraw_deposit!VBBuffer./VBBuffer/instance x)) (height (Poly%withdraw_deposit!VBBuffer.
       x
   ))))
   :pattern ((height (withdraw_deposit!VBBuffer./VBBuffer/instance x)))
   :qid prelude_datatype_height_withdraw_deposit!VBBuffer./VBBuffer/instance
   :skolemid skolem_prelude_datatype_height_withdraw_deposit!VBBuffer./VBBuffer/instance
)))
(assert
 (forall ((x withdraw_deposit!InvariantPredicate_auto_VBBuffer_start.)) (!
   (= x (%Poly%withdraw_deposit!InvariantPredicate_auto_VBBuffer_start. (Poly%withdraw_deposit!InvariantPredicate_auto_VBBuffer_start.
      x
   )))
   :pattern ((Poly%withdraw_deposit!InvariantPredicate_auto_VBBuffer_start. x))
   :qid internal_withdraw_deposit__InvariantPredicate_auto_VBBuffer_start_box_axiom_definition
   :skolemid skolem_internal_withdraw_deposit__InvariantPredicate_auto_VBBuffer_start_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x TYPE%withdraw_deposit!InvariantPredicate_auto_VBBuffer_start.)
    (= x (Poly%withdraw_deposit!InvariantPredicate_auto_VBBuffer_start. (%Poly%withdraw_deposit!InvariantPredicate_auto_VBBuffer_start.
       x
   ))))
   :pattern ((has_type x TYPE%withdraw_deposit!InvariantPredicate_auto_VBBuffer_start.))
   :qid internal_withdraw_deposit__InvariantPredicate_auto_VBBuffer_start_unbox_axiom_definition
   :skolemid skolem_internal_withdraw_deposit__InvariantPredicate_auto_VBBuffer_start_unbox_axiom_definition
)))
(assert
 (forall ((x withdraw_deposit!InvariantPredicate_auto_VBBuffer_start.)) (!
   (has_type (Poly%withdraw_deposit!InvariantPredicate_auto_VBBuffer_start. x) TYPE%withdraw_deposit!InvariantPredicate_auto_VBBuffer_start.)
   :pattern ((has_type (Poly%withdraw_deposit!InvariantPredicate_auto_VBBuffer_start. x)
     TYPE%withdraw_deposit!InvariantPredicate_auto_VBBuffer_start.
   ))
   :qid internal_withdraw_deposit__InvariantPredicate_auto_VBBuffer_start_has_type_always_definition
   :skolemid skolem_internal_withdraw_deposit__InvariantPredicate_auto_VBBuffer_start_has_type_always_definition
)))
(assert
 (forall ((x tuple%0.)) (!
...
;; Function-Decl withdraw_deposit::VBQueue::Instance::id
(declare-fun withdraw_deposit!VBQueue.impl&%7.id.? (Dcr Type Poly) vstd!tokens.InstanceId.)

;; Function-Decl withdraw_deposit::VBQueue::Instance::backing_cells
(declare-fun withdraw_deposit!VBQueue.impl&%7.backing_cells.? (Dcr Type Poly) vstd!seq.Seq<vstd!cell.CellId.>.)
...
;; Function-Decl withdraw_deposit::VBBuffer::wf
(declare-fun withdraw_deposit!impl&%1.wf.? (Dcr Type Poly) Bool)
...
;; Function-Specs withdraw_deposit::VBQueue::Instance::clone
(declare-fun ens%withdraw_deposit!VBQueue.impl&%7.clone. (Dcr Type Poly Poly) Bool)
(assert
 (forall ((T&. Dcr) (T& Type) (self! Poly) (s! Poly)) (!
   (= (ens%withdraw_deposit!VBQueue.impl&%7.clone. T&. T& self! s!) (and
     (has_type s! (TYPE%withdraw_deposit!VBQueue.Instance. T&. T&))
     (= self! s!)
   ))
   :pattern ((ens%withdraw_deposit!VBQueue.impl&%7.clone. T&. T& self! s!))
   :qid internal_ens__withdraw_deposit!VBQueue.impl&__7.clone._definition
   :skolemid skolem_internal_ens__withdraw_deposit!VBQueue.impl&__7.clone._definition
)))
...
(assert
 (forall ((T&. Dcr) (T& Type)) (!
   (=>
    (sized T&.)
    (tr_bound%vstd!tokens.ValueToken. $ (TYPE%withdraw_deposit!VBQueue.start. T&. T&)
     $ NAT
   ))
   :pattern ((tr_bound%vstd!tokens.ValueToken. $ (TYPE%withdraw_deposit!VBQueue.start.
      T&. T&
     ) $ NAT
   ))
   :qid internal_withdraw_deposit__VBQueue__impl&__5_trait_impl_definition
   :skolemid skolem_internal_withdraw_deposit__VBQueue__impl&__5_trait_impl_definition
)))

;; Function-Axioms withdraw_deposit::InvariantPredicate_auto_VBBuffer_start::atomic_inv
(assert
 (fuel_bool_default fuel%withdraw_deposit!impl&%0.atomic_inv.)
)
(assert
 (=>
  (fuel_bool fuel%withdraw_deposit!impl&%0.atomic_inv.)
  (forall ((T&. Dcr) (T& Type) (declare_struct_with_invariants_tmp_k! Poly) (declare_struct_with_invariants_tmp_v!
    ...
    (=>
     (sized T&.)
     (= (vstd!atomic_ghost.AtomicInvariantPredicate.atomic_inv.? $ TYPE%withdraw_deposit!InvariantPredicate_auto_VBBuffer_start.
       (TRACKED $) (TYPE%withdraw_deposit!VBQueue.Instance. T&. T&) $ (UINT 64) $ (TYPE%withdraw_deposit!VBQueue.start.
        T&. T&
        ...
        (let
         ...
         (let
          ...
          (and
           (= (%Poly%vstd!tokens.InstanceId. (vstd!tokens.ValueToken.instance_id.? $ (TYPE%withdraw_deposit!VBQueue.start.
               T&. T&
              ) $ NAT g$
             )
            ) (withdraw_deposit!VBQueue.impl&%7.id.? T&. T& instance$)
           )
           (= (%I (vstd!tokens.ValueToken.value.? $ (TYPE%withdraw_deposit!VBQueue.start. T&. T&)
              $ NAT g$
             )
            ) v$
    ))))))))
    :pattern ((vstd!atomic_ghost.AtomicInvariantPredicate.atomic_inv.? $ TYPE%withdraw_deposit!InvariantPredicate_auto_VBBuffer_start.
      (TRACKED $) (TYPE%withdraw_deposit!VBQueue.Instance. T&. T&) $ (UINT 64) $ (TYPE%withdraw_deposit!VBQueue.start.
       T&. T&
      ) declare_struct_with_invariants_tmp_k! declare_struct_with_invariants_tmp_v! declare_struct_with_invariants_tmp_g!
    ))
...
(assert
 (forall ((T&. Dcr) (T& Type)) (!
   (=>
    (sized T&.)
    (tr_bound%vstd!atomic_ghost.AtomicInvariantPredicate. $ TYPE%withdraw_deposit!InvariantPredicate_auto_VBBuffer_start.
     (TRACKED $) (TYPE%withdraw_deposit!VBQueue.Instance. T&. T&) $ (UINT 64) $ (TYPE%withdraw_deposit!VBQueue.start.
      T&. T&
   )))
   :pattern ((tr_bound%vstd!atomic_ghost.AtomicInvariantPredicate. $ TYPE%withdraw_deposit!InvariantPredicate_auto_VBBuffer_start.
     (TRACKED $) (TYPE%withdraw_deposit!VBQueue.Instance. T&. T&) $ (UINT 64) $ (TYPE%withdraw_deposit!VBQueue.start.
      T&. T&
   )))
   :qid internal_withdraw_deposit__impl&__0_trait_impl_definition
   :skolemid skolem_internal_withdraw_deposit__impl&__0_trait_impl_definition
)))

;; Function-Axioms withdraw_deposit::VBBuffer::wf
(assert
 (fuel_bool_default fuel%withdraw_deposit!impl&%1.wf.)
)
(assert
 (=>
  (fuel_bool fuel%withdraw_deposit!impl&%1.wf.)
  (forall ((T&. Dcr) (T& Type) (self! Poly)) (!
    (= (withdraw_deposit!impl&%1.wf.? T&. T& self!) (and
      (and
       (and
        (= (vstd!seq.Seq.len.? $ TYPE%vstd!cell.CellId. (Poly%vstd!seq.Seq<vstd!cell.CellId.>.
           (withdraw_deposit!VBQueue.impl&%7.backing_cells.? T&. T& (withdraw_deposit!VBBuffer./VBBuffer/instance
             (%Poly%withdraw_deposit!VBBuffer. self!)
          )))
           ...
           ) (withdraw_deposit!VBBuffer./VBBuffer/buffer (%Poly%withdraw_deposit!VBBuffer. self!))
        )))
        (forall ((i$ Poly)) (!
          (=>
           (has_type i$ INT)
           (=>
            (and
             ...
             (< (%I i$) (vstd!seq.Seq.len.? $ (TYPE%vstd!cell.PCell. T&. T&) (vstd!view.View.view.?
                $ (TYPE%alloc!vec.Vec. $ (TYPE%vstd!cell.PCell. T&. T&) $ ALLOCATOR_GLOBAL) (withdraw_deposit!VBBuffer./VBBuffer/buffer
                 (%Poly%withdraw_deposit!VBBuffer. self!)
            )))))
          ...
          :qid user_withdraw_deposit__VBBuffer__wf_42
          :skolemid skolem_user_withdraw_deposit__VBBuffer__wf_42
       )))
       (vstd!atomic_ghost.impl&%1.well_formed.? (TRACKED $) (TYPE%withdraw_deposit!VBQueue.Instance.
         T&. T&
        ) $ (TYPE%withdraw_deposit!VBQueue.start. T&. T&) $ TYPE%withdraw_deposit!InvariantPredicate_auto_VBBuffer_start.
        (Poly%vstd!atomic_ghost.AtomicU64. (withdraw_deposit!VBBuffer./VBBuffer/start (%Poly%withdraw_deposit!VBBuffer.
           self!
      )))))
      (= (vstd!atomic_ghost.impl&%1.constant.? (TRACKED $) (TYPE%withdraw_deposit!VBQueue.Instance.
         T&. T&
        ) $ (TYPE%withdraw_deposit!VBQueue.start. T&. T&) $ TYPE%withdraw_deposit!InvariantPredicate_auto_VBBuffer_start.
        (Poly%vstd!atomic_ghost.AtomicU64. (withdraw_deposit!VBBuffer./VBBuffer/start (%Poly%withdraw_deposit!VBBuffer.
           self!
        )))
       ) (withdraw_deposit!VBBuffer./VBBuffer/instance (%Poly%withdraw_deposit!VBBuffer. self!))
    )))
    :pattern ((withdraw_deposit!impl&%1.wf.? T&. T& self!))
    :qid internal_withdraw_deposit!impl&__1.wf.?_definition
    :skolemid skolem_internal_withdraw_deposit!impl&__1.wf.?_definition
))))
...
;; Function-Specs withdraw_deposit::VBQueue::Instance::initialize
(declare-fun req%withdraw_deposit!VBQueue.impl&%7.initialize. (Dcr Type vstd!seq.Seq<vstd!cell.CellId.>.
  Poly Poly
 ) Bool
)
...
(assert
 (forall ((T&. Dcr) (T& Type) (backing_cells! vstd!seq.Seq<vstd!cell.CellId.>.) (storage!
   ...
   (= (req%withdraw_deposit!VBQueue.impl&%7.initialize. T&. T& backing_cells! storage!
     param_token_storage!
    ) (and
     (=>
      ...
      (forall ((i$ Poly)) (!
        ...
        :qid user_withdraw_deposit__VBQueue__Instance__initialize_43
        :skolemid skolem_user_withdraw_deposit__VBQueue__Instance__initialize_43
     )))
     (=>
   ...
   :pattern ((req%withdraw_deposit!VBQueue.impl&%7.initialize. T&. T& backing_cells! storage!
     param_token_storage!
   ))
   :qid internal_req__withdraw_deposit!VBQueue.impl&__7.initialize._definition
   :skolemid skolem_internal_req__withdraw_deposit!VBQueue.impl&__7.initialize._definition
)))
(declare-fun ens%withdraw_deposit!VBQueue.impl&%7.initialize. (Dcr Type vstd!seq.Seq<vstd!cell.CellId.>.
  Poly Poly tuple%2.
 ) Bool
)
(assert
 (forall ((T&. Dcr) (T& Type) (backing_cells! vstd!seq.Seq<vstd!cell.CellId.>.) (storage!
    Poly
   ) (param_token_storage! Poly) (tmp_tuple! tuple%2.)
  ) (!
   (= (ens%withdraw_deposit!VBQueue.impl&%7.initialize. T&. T& backing_cells! storage!
     param_token_storage! tmp_tuple!
    ) (and
     (has_type (Poly%tuple%2. tmp_tuple!) (TYPE%tuple%2. (TRACKED $) (TYPE%withdraw_deposit!VBQueue.Instance.
        T&. T&
       ) (TRACKED $) (TYPE%withdraw_deposit!VBQueue.start. T&. T&)
     ))
     (let
      ((instance$ (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp_tuple!)))))
      (let
       ((param_token_start$ (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp_tuple!)))))
       (let
        ((instance$1 instance$))
        (let
         ((param_token_start$1 param_token_start$))
         (and
          (and
           (= (%Poly%vstd!tokens.InstanceId. (vstd!tokens.ValueToken.instance_id.? $ (TYPE%withdraw_deposit!VBQueue.start.
               T&. T&
              ) $ NAT param_token_start$1
             )
            ) (withdraw_deposit!VBQueue.impl&%7.id.? T&. T& instance$1)
           )
           (= (withdraw_deposit!VBQueue.impl&%7.backing_cells.? T&. T& instance$1) backing_cells!)
          )
          (= (%I (vstd!tokens.ValueToken.value.? $ (TYPE%withdraw_deposit!VBQueue.start. T&. T&)
             $ NAT param_token_start$1
            )
   ...
   :pattern ((ens%withdraw_deposit!VBQueue.impl&%7.initialize. T&. T& backing_cells! storage!
     param_token_storage! tmp_tuple!
   ))
   :qid internal_ens__withdraw_deposit!VBQueue.impl&__7.initialize._definition
   :skolemid skolem_internal_ens__withdraw_deposit!VBQueue.impl&__7.initialize._definition
)))

;; Function-Specs withdraw_deposit::VBBuffer::checkout_first
(declare-fun req%withdraw_deposit!impl&%2.checkout_first. (Dcr Type withdraw_deposit!VBBuffer.)
 Bool
)
(declare-const %%global_location_label%%10 Bool)
(assert
 (forall ((T&. Dcr) (T& Type) (pre%self! withdraw_deposit!VBBuffer.)) (!
   (= (req%withdraw_deposit!impl&%2.checkout_first. T&. T& pre%self!) (=>
     %%global_location_label%%10
     (withdraw_deposit!impl&%1.wf.? T&. T& (Poly%withdraw_deposit!VBBuffer. pre%self!))
   ))
   :pattern ((req%withdraw_deposit!impl&%2.checkout_first. T&. T& pre%self!))
   :qid internal_req__withdraw_deposit!impl&__2.checkout_first._definition
   :skolemid skolem_internal_req__withdraw_deposit!impl&__2.checkout_first._definition
)))
(declare-fun ens%withdraw_deposit!impl&%2.checkout_first. (Dcr Type withdraw_deposit!VBBuffer.
  withdraw_deposit!VBBuffer.
 ) Bool
)
(assert
 (forall ((T&. Dcr) (T& Type) (pre%self! withdraw_deposit!VBBuffer.) (self! withdraw_deposit!VBBuffer.))
  (!
   (= (ens%withdraw_deposit!impl&%2.checkout_first. T&. T& pre%self! self!) (and
     (has_type (Poly%withdraw_deposit!VBBuffer. self!) (TYPE%withdraw_deposit!VBBuffer.
       T&. T&
     ))
     (withdraw_deposit!impl&%1.wf.? T&. T& (Poly%withdraw_deposit!VBBuffer. self!))
   ))
   :pattern ((ens%withdraw_deposit!impl&%2.checkout_first. T&. T& pre%self! self!))
   :qid internal_ens__withdraw_deposit!impl&__2.checkout_first._definition
   :skolemid skolem_internal_ens__withdraw_deposit!impl&__2.checkout_first._definition
)))

;; Function-Def withdraw_deposit::VBBuffer::checkout_first
;; withdraw_deposit.rs:132:5: 132:33 (#0)
(get-info :all-statistics)
(push)
 (declare-const T&. Dcr)
 (declare-const T& Type)
 (declare-const self!@0 withdraw_deposit!VBBuffer.)
 (declare-const tmp%1 Poly)
 (declare-const tmp%2@0 tuple%2.)
 (declare-const pair~78@0 tuple%2.)
 (declare-const verus_tmp_perm@ vstd!atomic.PermissionU64.)
 (declare-const verus_tmp_start_token@0 Poly)
 (declare-const tmp%3 vstd!atomic.PAtomicU64.)
 (declare-const verus_tmp_start@ Int)
 (declare-const tmp%4 Poly)
 (declare-const tmp%%@ tuple%0.)
 (declare-const verus_tmp@ tuple%2.)
 (declare-const perm@0 vstd!atomic.PermissionU64.)
 (declare-const start_token@0 Poly)
 (declare-const verus_tmp$1@0 Int)
 (declare-const start$1@0 Int)
 ...
 (assert
  (has_type (Poly%withdraw_deposit!VBBuffer. self!@0) (TYPE%withdraw_deposit!VBBuffer.
    T&. T&
 )))
 (assert
  (withdraw_deposit!impl&%1.wf.? T&. T& (Poly%withdraw_deposit!VBBuffer. self!@0))
 )
 (declare-const perm@1 vstd!atomic.PermissionU64.)
 (declare-const start_token@1 Poly)
 (declare-const verus_tmp$1@1 Int)
 (declare-const start$1@1 Int)
 (declare-const verus_tmp$2@1 Int)
 (declare-const verus_tmp$3@1 Int)
 (declare-const pair~78@1 tuple%2.)
 ...
 (assert
  (not (=>
    (= atomic@ (withdraw_deposit!VBBuffer./VBBuffer/start (%Poly%withdraw_deposit!VBBuffer.
       (Poly%withdraw_deposit!VBBuffer. self!@0)
    )))
    (=>
     ...
     (=>
      (has_type (Poly%tuple%2. tmp%2@0) (TYPE%tuple%2. $ TYPE%vstd!atomic.PermissionU64.
        $ (TYPE%withdraw_deposit!VBQueue.start. T&. T&)
      ))
      (=>
       (= pair~78@0 tmp%2@0)
       (=>
        (vstd!invariant.AtomicInvariant.inv.? (DST $) (TYPE%tuple%2. (TRACKED $) (TYPE%withdraw_deposit!VBQueue.Instance.
           T&. T&
          ) $ INT
         ) (DST $) (TYPE%tuple%2. $ TYPE%vstd!atomic.PermissionU64. $ (TYPE%withdraw_deposit!VBQueue.start.
           T&. T&
          )
         ) $ (TYPE%vstd!atomic_ghost.AtomicPredU64. $ TYPE%withdraw_deposit!InvariantPredicate_auto_VBBuffer_start.)
         tmp%1 (Poly%tuple%2. pair~78@0)
        )
        (=>
         (= verus_tmp@ pair~78@0)
         (=>
          ...
          (=>
           (= verus_tmp_start_token@0 (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. verus_tmp@))))
           (=>
            (= perm@1 verus_tmp_perm@)
            (=>
             (= start_token@1 verus_tmp_start_token@0)
             (=>
              ...
              (and
               ...
               (=>
                ...
                (=>
                 ...
                 (=>
                  (= verus_tmp_start@ verus_tmp$1@1)
                  (=>
                   (= start$1@1 verus_tmp_start@)
                   (=>
                    (= verus_tmp$2@1 result@)
                    (=>
                     (= verus_tmp$3@1 result@)
                     (=>
                      (= tmp%4 (withdraw_deposit!VBBuffer./VBBuffer/instance (%Poly%withdraw_deposit!VBBuffer.
                         (Poly%withdraw_deposit!VBBuffer. self!@0)
                      )))
                      (=>
                       (= pair~78@1 (tuple%2./tuple%2 (Poly%vstd!atomic.PermissionU64. perm@1) start_token@1))
                       (and
                        (=>
                         %%location_label%%1
                         (vstd!invariant.AtomicInvariant.inv.? (DST $) (TYPE%tuple%2. (TRACKED $) (TYPE%withdraw_deposit!VBQueue.Instance.
...
;; Function-Specs withdraw_deposit::new_buf
(declare-fun req%withdraw_deposit!new_buf. (Dcr Type Int) Bool)
(declare-const %%global_location_label%%11 Bool)
(assert
 (forall ((T&. Dcr) (T& Type) (len! Int)) (!
   (= (req%withdraw_deposit!new_buf. T&. T& len!) (=>
     %%global_location_label%%11
     (> len! 0)
   ))
   :pattern ((req%withdraw_deposit!new_buf. T&. T& len!))
   :qid internal_req__withdraw_deposit!new_buf._definition
   :skolemid skolem_internal_req__withdraw_deposit!new_buf._definition
)))
(declare-fun ens%withdraw_deposit!new_buf. (Dcr Type Int withdraw_deposit!VBBuffer.)
 Bool
)
(assert
 (forall ((T&. Dcr) (T& Type) (len! Int) (vbuf! withdraw_deposit!VBBuffer.)) (!
   (= (ens%withdraw_deposit!new_buf. T&. T& len! vbuf!) (and
     (has_type (Poly%withdraw_deposit!VBBuffer. vbuf!) (TYPE%withdraw_deposit!VBBuffer.
       T&. T&
     ))
     (withdraw_deposit!impl&%1.wf.? T&. T& (Poly%withdraw_deposit!VBBuffer. vbuf!))
   ))
   :pattern ((ens%withdraw_deposit!new_buf. T&. T& len! vbuf!))
   :qid internal_ens__withdraw_deposit!new_buf._definition
   :skolemid skolem_internal_ens__withdraw_deposit!new_buf._definition
)))

;; Function-Def withdraw_deposit::new_buf
;; withdraw_deposit.rs:160:5: 160:40 (#154)
(get-info :all-statistics)
(push)
 (declare-const T&. Dcr)
 (declare-const T& Type)
 (declare-const vbuf! withdraw_deposit!VBBuffer.)
 ...
 (declare-const verus_tmp_start_token@ Poly)
 ...
 (declare-const verus_tmp$3@ tuple%2.)
 (declare-const instance@0 Poly)
 (declare-const start_token@0 Poly)
 (declare-const tracked_inst@ Poly)
 (declare-const start_atomic@ vstd!atomic_ghost.AtomicU64.)
 (assert
  fuel_defaults
 )
 (assert
 ...
 (assert
  (not (=>
    (forall ((j$ Poly)) (!
      ...
      :qid user_withdraw_deposit__new_buf_44
      :skolemid skolem_user_withdraw_deposit__new_buf_44
    ))
    (=>
...
;; Function-Def withdraw_deposit::new_buf
;; withdraw_deposit.rs:149:1: 149:52 (#0)
(get-info :all-statistics)
(push)
 (declare-const T&. Dcr)
 (declare-const T& Type)
              ...
              (=>
               ...
               (=>
                ...
                (and
                 (=>
                  %%location_label%%1
                  (req%withdraw_deposit!VBQueue.impl&%7.initialize. T&. T& backing_cells_ids@1 perms@2
                   perms@2
                 ))
                 (=>
                  (ens%withdraw_deposit!VBQueue.impl&%7.initialize. T&. T& backing_cells_ids@1 perms@2
                   perms@2 verus_tmp$3@
                  )
                  (=>
                   (= verus_tmp_instance@ (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. verus_tmp$3@))))
                   (=>
                    (= verus_tmp_start_token@ (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. verus_tmp$3@))))
                    (=>
                     (= instance@1 verus_tmp_instance@)
                     (=>
                      (= start_token@1 verus_tmp_start_token@)
                      (=>
                       (ens%withdraw_deposit!VBQueue.impl&%7.clone. T&. T& instance@1 tracked_inst@)
                       (and
                        (=>
                         %%location_label%%2
                         (req%vstd!atomic_ghost.impl&%1.new. (TRACKED $) (TYPE%withdraw_deposit!VBQueue.Instance.
                           T&. T&
                          ) $ (TYPE%withdraw_deposit!VBQueue.start. T&. T&) $ TYPE%withdraw_deposit!InvariantPredicate_auto_VBBuffer_start.
                          tracked_inst@ 0 start_token@1
                        ))
                        (=>
                         (ens%vstd!atomic_ghost.impl&%1.new. (TRACKED $) (TYPE%withdraw_deposit!VBQueue.Instance.
                           T&. T&
                          ) $ (TYPE%withdraw_deposit!VBQueue.start. T&. T&) $ TYPE%withdraw_deposit!InvariantPredicate_auto_VBBuffer_start.
                          tracked_inst@ 0 start_token@1 start_atomic@
                         )
                         (=>
                          (= vbuf! (withdraw_deposit!VBBuffer./VBBuffer backing_cells_vec@1 (%Poly%vstd!atomic_ghost.AtomicU64.
                             (Poly%vstd!atomic_ghost.AtomicU64. start_atomic@)
                            ) instance@1
                          ))
                          (=>
                           %%location_label%%3
...
;; Function-Def withdraw_deposit::main
;; withdraw_deposit.rs:204:1: 204:10 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const vbuf@0 withdraw_deposit!VBBuffer.)
 (declare-const tmp%%@ tuple%0.)
 (assert
  fuel_defaults
 )
 (declare-const vbuf@1 withdraw_deposit!VBBuffer.)
 ;; precondition not satisfied
 (declare-const %%location_label%%0 Bool)
 ;; precondition not satisfied
 (declare-const %%location_label%%1 Bool)
 (assert
  (not (and
    (=>
     %%location_label%%0
     (req%withdraw_deposit!new_buf. $ (UINT 32) 5)
    )
    (=>
     (ens%withdraw_deposit!new_buf. $ (UINT 32) 5 vbuf@0)
     (=>
      %%location_label%%1
      (req%withdraw_deposit!impl&%2.checkout_first. $ (UINT 32) vbuf@0)
 )))))
 (get-info :version)
 (set-option :rlimit 30000000)
 (check-sat)
